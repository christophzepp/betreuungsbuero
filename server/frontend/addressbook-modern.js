...
function drawDetail(c){
 ...
 meta.append(E('span','am-sub',c.role||'Ohne Rolle'),E('span','am-badge'+(isEnded(c)?' ended':''),c.status||'Aktiv'));summary.append(E('h2','',name(c)),meta);identityBlock.append(summary);top.append(identityBlock,B(c.__viewMergeId?'Fallkontakte öffnen':'Bearbeiten',()=>edit(c),'am-contact-edit'));header.append(top);pane.append(header);
