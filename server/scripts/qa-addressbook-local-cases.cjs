...
module.exports=async({page,mobile,errors})=>{
 ...
 await page.evaluate(()=>{
  window.__appMode='local';window.__demoModus=false;window.__activeServerCaseId='alter-online-fall';window.__abScope='case';window.__abBueroWide=false;
 ...
 await check('Lokaler Modus zeigt den Herkunftsfall auch für Kontakte ohne ID, mit aktuellen Fall- und Kontaktdaten',async()=>{
